...
for phoneme in unique_labels:
	...
	mfcc_delta_models[phoneme]=pickle.load(open("./models/"+phoneme+"/ec_mfcc_delta.pkl", 'rb'))
	mfcc_delta_models_w[phoneme]=pickle.load(open("./models/"+phoneme+"/wec_mfcc_delta.pkl", 'rb'))

	mfcc_delta_delta_models[phoneme]=pickle.load(open("./models/"+phoneme+"/ec_mfcc_delta_delta.pkl", 'rb'))
	mfcc_delta_delta_models_w[phoneme]=pickle.load(open("./models/"+phoneme+"/wec_mfcc_delta_delta.pkl", 'rb'))
...
classify(mfcc_delta_delta_models, mfcc_delta_delta_models_w,test_mfcc_delta_delta,[0,13,26])
